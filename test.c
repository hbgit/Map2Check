...
// FORTES: Claim 22
   __MAP_FORTES_assert(!(IS_VALID_POINTER_FORTES(list_LOG_mcf, (void *)&((link)), (void *)(intptr_t)(NULL))) || (intptr_t)link == NULL, "[Failed]\n VIOLATED PROPERTY: Claim 22 \n \t Location at original code in line: 65 \n \t Comments:   dereference failure: invalid pointer\n \n FALSE(valid-deref) \n ");
...
// FORTES: Claim 25
      __MAP_FORTES_assert(!(IS_VALID_POINTER_FORTES(list_LOG_mcf, (void *)&((link)), (void *)(intptr_t)(NULL))), "[Failed]\n VIOLATED PROPERTY: Claim 25 \n \t Location at original code in line: 71 \n \t Comments:   dereference failure: invalid pointer\n \n FALSE(valid-deref) \n ");
...
// FORTES: Claim 27
   ...
   *cursor      = head;
   list_LOG_mcf = mark_map_FORTES(list_LOG_mcf, (void *)&(cursor), (void *)(intptr_t)(NULL), "cursor", 2, 0, 0, 0, "item_t", 73); /** by FORTES **/
...
// FORTES: Claim 56
      __MAP_FORTES_assert(!(IS_VALID_POINTER_FORTES(list_LOG_mcf, (void *)&((cursor)), (void *)(intptr_t)(NULL))), "[Failed]\n VIOLATED PROPERTY: Claim 56 \n \t Location at original code in line: 149 \n \t Comments:   dereference failure: invalid pointer\n \n FALSE(valid-deref) \n ");
