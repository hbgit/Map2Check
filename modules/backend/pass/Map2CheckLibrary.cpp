...
void Map2CheckLibrary::runOnCallInstruction(CallInst *callInst, LLVMContext* Ctx) {
...
static RegisterPass<Map2CheckLibrary> X("map2check", "Adds support for map2check library (MUST be executed before other pass)");
