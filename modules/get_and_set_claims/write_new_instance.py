        ...
        try:
            with open(mapFileCsv, 'r') as fileCsv:                
                ...
                for row in reader:                                          
                    ...
                    # LOC
                    self.map_original_line_program.append(row['LOC'])
                    # Is Free
                    self.map_is_free2map.append(row['Is Free'])
                    # After_Pre_LOC                    
                    ...
                    # Variable
                    self.map_var2map.append(row['Variable'])
                    # Is Dynamic
                    self.map_is_dynam2map.append(int(row['Is Dynamic']))     
                    # Is Global
                    self.map_is_global2map.append(int(row['Is Global']))
                    # Points to
