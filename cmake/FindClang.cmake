...
if(USE_PREBUILT_CLANG)
  if(NOT EXISTS dependencies/${PRE_BUILT_CLANG})
    ...
    find_local_llvm(CLANG_CC clang-3.9)    
  ...
  find_program(CLANG_CC clang-3.9)
  find_program(CLANG_CXX clang++-3.9)
  find_program(LLVM_CONFIG llvm-config-3.9 DOC "llvm-config is used to generate flags to link with llvm.")
endif()
