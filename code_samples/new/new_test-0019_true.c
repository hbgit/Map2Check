...
{
   list_LOG_mcf = mark_map_FORTES(list_LOG_mcf, (void *)&(data), (void *)(intptr_t)(NULL), 2, 0, 0, 0, 14); /** by FORTES **/
...
int main()
{
   ...
   list_LOG_mcf = mark_map_FORTES(list_LOG_mcf, (void *)&(data), (void *)(intptr_t)(NULL), 3, 0, 0, 0, 27); /** by FORTES **/
